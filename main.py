...
BOT_TOKEN = "6463215236:AAFGdSDnkL5S93e-JisF_tsVr35IHrg19Wg"
PAYMENT_CHANNEL = "@khantgaccseller" #add payment channel here including the '@' sign
OWNER_ID = 5151868182 #write owner's user id here.. get it from @MissRose_Bot by /id
CHANNELS = ["@khantgaccseller"] #add channels to be checked here in the format - ["Channel 1", "Channel 2"] 
